...
namespace SupremeMelee
{
    ...
    public class SupremeMeleeModSettings : ModSettings
	{
		...
		{
			Scribe_Values.Look(ref verboseParryReadout, "verboseParryReadout", false, false);
			Scribe_Values.Look(ref parryMagnitude, "parryMagnitude", 2f, false);
			Scribe_Values.Look(ref maximumParryChance, "maximumParryChance", 0.95f, false);
			Scribe_Values.Look(ref animalSizeScaling, "animalSizeScaling", true, false);
		}
		...
		public bool verboseParryReadout = false;
